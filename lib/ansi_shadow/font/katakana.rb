...
module AnsiShadow
  module Font
    ##
    # 7x7 Katakana gylphs for ANSI Shadow font
    #
    # Inspired by the sprites found in The Legend of Zelda (NES)
    # @see https://legendsoflocalization.com/comparisons/the-legend-of-zelda/gameplay/
    ...
    module Katakana
      ...
      XA = AnsiShadow::Glyph.from_mono <<~TEXT.chomp
      ...
      XU = AnsiShadow::Glyph.from_mono <<~TEXT.chomp
      ...
      XO = AnsiShadow::Glyph.from_mono <<~TEXT.chomp
